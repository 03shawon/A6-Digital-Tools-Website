const Steps = () => {
  const stepList = [
    { id: "01", title: "Create Account", desc: "Sign up for free in seconds.", icon: "👤" },
    { id: "02", title: "Choose Products", desc: "Select the tools that fit your needs.", icon: "📦" },
    { id: "03", title: "Start Creating", desc: "Download and start using immediately.", icon: "🚀" }
  ];
